...
<div class="container" style="height: 10%">
	...
	<div style="height: 100px;">
		<ul class="navbar">
			...
			<li><a style="color: white" href="culturalnew.php">Cultural</a></li>
...
<div>
	<div style="float: left;padding-left: 18%;padding-top: 80px;"><img src="cul1.jpg" width="260" height="260"></div>
	<div style="color: black;width: 48%;font-size: 25px;float: left;padding-top: 65px;padding-left: 3%"><p>Hello Sfitians,<br><br>Welcome! Our website contains information on past projects, ongoing initiatives, and future work. Please contact us at sfsc@sfit.edu to share any ideas you have or challenges you face.<br><br>We are excited to work with you to address student concerns and improve the undergraduate experience.<br><br>Best regards,<br><br><i>Apurva Naik</i><br><br><i>Cultural Secretary 2017-2018</i></p></div>
</div>
...
<div class="wrapevent">
	...
	<div style="padding-top:0.5%">
		<div style="float: left;margin-left: 6%;padding-right: 2%"><img src="cultural.jpg" width="220" height="180"></div>
		<div>
			<p style="font-size: 20px;">REGISTER FOR CULTURAL EVENT!!!!</p>
